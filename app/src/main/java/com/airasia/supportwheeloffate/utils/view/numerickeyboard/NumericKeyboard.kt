package com.airasia.supportwheeloffate.utils.view.numerickeyboard
...
import com.eightsquarei.eremitpay.utils.view.numerickeyboard.util.KeyClickListener
import com.eightsquarei.eremitpay.utils.view.numerickeyboard.util.ViewRunnable
import com.eightsquarei.eremitpay.utils.view.numerickeyboard.util.suppressSoftKeyboard
...
class NumericKeyboard : FrameLayout {
    ...
    private fun initAttributes(context: Context, attrs: AttributeSet, defStyleAttr: Int) {
        ...
        keyTextSize =
            attributes.getDimensionPixelSize(R.styleable.NumericKeyboard_keyTextSize, defaultKeyTextSize).toFloat()
